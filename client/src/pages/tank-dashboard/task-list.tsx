import { CalendarIcon as CalendarIcon, TrashIcon} from 'lucide-react'
                ...
                <>
                    <div className="flex items-center justify-between p-1 rounded-lg ">
                        ...
                        <div className="flex items-center text-sm">
                            ...
                            <TrashIcon className="ml-10 h-8 w-4 mr-4 hover:stroke-destructive" onClick={()=> handleDelete(task.id)}/>
                        </div>
                    </div>
                </>
            )
