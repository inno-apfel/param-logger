...
export function SimpleEditor({editable, content, onChange}: {editable: boolean, content?: JSONContent, onChange?: (json: JSONContent) => void}) {
    ...
    <div className="simple-editor-wrapper">
      <EditorContext.Provider value={{ editor }}>
        ...
        <EditorContent
          editor={editor}
          role="presentation"
          className="simple-editor-content text-sm"
        />
